    ...
    <div>
      ...
      <div class="px-12 mb-8">
        ...
        <p class="text-justify">
          ...
          elementum justo vitae quam vestibulum congue. In hac habitasse platea
          dictumst. Ut tincidunt eget nunc ac euismod. Orci varius natoque
          penatibus et magnis dis parturient montes, nascetur ridiculus mus.
          Phasellus non augue volutpat, bibendum erat venenatis, tincidunt mi.
          Morbi gravida quam quam, non tincidunt ex efficitur a. Sed finibus
          interdum turpis, et maximus est ullamcorper non. Suspendisse potenti.
          Quisque ac convallis augue. Phasellus eros nisi, rutrum eu sapien ut,
          convallis porta velit. In hac habitasse platea dictumst. Proin
          ullamcorper purus in quam feugiat, eget tincidunt dui fermentum.
          Nullam nulla libero, gravida at mattis vel, ultrices sed tortor. Sed
          sit amet mattis nunc, et pharetra sem.
        </p>
      </div>
